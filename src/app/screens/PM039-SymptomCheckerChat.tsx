                  ...
                  <div className="mt-2.5 space-y-2">
                    {message.options.map((option, index) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 bg-white border border-[#E5E7EB] rounded-xl text-[15px] text-[#1F2937] hover:border-[#1E3A8A]/40 hover:bg-[#EFF6FF] transition-all group"
                        style={{ boxShadow: '0 1px 2px rgba(0,0,0,0.03)' }}
                      >
                        <span className="group-hover:text-[#2563EB] transition-colors">{option}</span>
                      </button>
                    ))}
                  </div>
                )}
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full h-[44px] px-4 rounded-xl border border-[#E5E7EB] text-[15px] focus:outline-none focus:border-[#1E3A8A] focus:ring-1 focus:ring-[#1E3A8A]/20 bg-[#F9FAFB] transition-all"
          ...
          <button
            ...
            className="w-[44px] h-[44px] bg-[#1E3A8A] rounded-xl flex items-center justify-center hover:bg-[#1E40AF] transition-colors disabled:opacity-30 disabled:cursor-not-allowed shrink-0"
          >
