    ...
    <div className="flex flex-col h-full bg-[#F8F9FA]">
      ...
      <div className="bg-white flex items-center gap-3 px-4 py-3 border-b border-[#E5E7EB]" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.04)' }}>
        ...
        <div className="flex items-center gap-2.5 flex-1">
          <div className="w-9 h-9 bg-[#FFC72C] rounded-xl flex items-center justify-center">
              ...
              <div className="max-w-[80%]">
                {message.sender === 'ai' && (
                  <div className="flex items-center gap-2 mb-1.5">
                    <div className="w-7 h-7 bg-[#FFC72C] rounded-lg flex items-center justify-center">
                ...
                <div
                  className={`rounded-2xl px-4 py-3 ${
                    message.sender === 'user'
                      ? 'bg-[#FFC72C] text-[#1F2937] rounded-tr-md'
                  ...
                  <div className="mt-2.5 space-y-2">
                    {message.options.map((option, index) => (
                      <button
                        ...
                        className="w-full text-left px-4 py-3 bg-white border border-[#E5E7EB] rounded-xl text-[15px] text-[#1F2937] hover:border-[#FFC72C]/40 hover:bg-[#FFFDF0] transition-all group"
                        style={{ boxShadow: '0 1px 2px rgba(0,0,0,0.03)' }}
                      >
                        <span className="group-hover:text-[#B8860B] transition-colors">{option}</span>
                      </button>
                    ))}
                  </div>
                )}
        ...
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full h-[44px] px-4 rounded-xl border border-[#E5E7EB] text-[15px] focus:outline-none focus:border-[#FFC72C] focus:ring-1 focus:ring-[#FFC72C]/20 bg-[#F9FAFB] transition-all"
          ...
          <button
            ...
            className="w-[44px] h-[44px] bg-[#FFC72C] rounded-xl flex items-center justify-center hover:bg-[#E5A800] transition-colors disabled:opacity-30 disabled:cursor-not-allowed shrink-0"
          >
