      ...
      <div className="px-4 py-4 border-b border-[#E5E7EB]">
        <div className="relative">
          ...
          <input
            ...
            className="w-full h-[48px] pl-12 pr-4 border border-[#E5E7EB] rounded-xl text-base focus:outline-none focus:border-[#FFC72C]"
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="p-5 bg-white border border-[#E5E7EB] rounded-2xl hover:border-[#FFC72C] transition-colors"
            >
        ...
        <div className="mb-6">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3 p-4 bg-white border border-[#E5E7EB] rounded-xl hover:border-[#FFC72C] transition-colors cursor-pointer">
