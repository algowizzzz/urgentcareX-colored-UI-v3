      ...
      <div className="flex-1 overflow-y-auto pb-8">
        ...
        <div className="px-6 py-6 border-b border-[#E5E7EB]">
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-between p-4 bg-white border border-[#E5E7EB] rounded-xl hover:border-[#1E3A8A] transition-colors">
        ...
        <div className="px-6 py-6">
          <div className="bg-[#10B981]/10 border-l-4 border-[#10B981] rounded-xl p-5 mb-6">
            ...
            <Button 
              ...
              className="w-full h-[48px] bg-[#1E3A8A] text-white rounded-xl text-base font-medium hover:bg-[#1E40AF]"
            >
