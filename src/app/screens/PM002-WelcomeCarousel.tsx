...
function ChatIllustration() {
  return (
    <svg width="240" height="200" viewBox="0 0 240 200" fill="none">
      ...
      {/* AI avatar */}
      <circle cx="76" cy="78" r="8" fill="#FFC72C" />
      <text x="76" y="82" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold">X</text>

      {/* User message bubble */}
      <rect x="104" y="86" width="60" height="22" rx="10" fill="#FFC72C" />
      ...
      {/* User message */}
      <rect x="110" y="150" width="54" height="18" rx="9" fill="#FFC72C" />
      <rect x="118" y="156" width="28" height="3" rx="1.5" fill="white" opacity="0.7" />

      {/* Floating decorative elements */}
      <circle cx="32" cy="50" r="12" fill="#FFC72C" opacity="0.1" />
      <circle cx="210" cy="140" r="16" fill="#FFC72C" opacity="0.08" />
      ...
      <rect x="50" y="0" width="140" height="200" rx="22" stroke="#FFC72C" strokeWidth="1" opacity="0.1" fill="none" />
      <rect x="42" y="-8" width="156" height="216" rx="28" stroke="#FFC72C" strokeWidth="0.5" opacity="0.06" fill="none" />
    </svg>
  );
}
...
function MapIllustration() {
  return (
    <svg width="240" height="200" viewBox="0 0 240 200" fill="none">
      ...
      <circle cx="125" cy="95" r="18" fill="#FFC72C" opacity="0.15" />
      <circle cx="125" cy="95" r="10" fill="#FFC72C" opacity="0.25" />
      <circle cx="125" cy="95" r="5" fill="#FFC72C" />
      ...
      {/* Distance line */}
      <line x1="125" y1="95" x2="80" y2="57" stroke="#FFC72C" strokeWidth="1.5" strokeDasharray="4 3" opacity="0.5" />
      <line x1="125" y1="95" x2="165" y2="47" stroke="#FFC72C" strokeWidth="1.5" strokeDasharray="4 3" opacity="0.5" />

      {/* Radius circle */}
      <circle cx="125" cy="95" r="55" stroke="#FFC72C" strokeWidth="1.5" strokeDasharray="6 4" fill="none" opacity="0.2" />

      {/* Decorative corners */}
      <circle cx="30" cy="30" r="4" fill="#F59E0B" opacity="0.3" />
      <circle cx="210" cy="170" r="4" fill="#FFC72C" opacity="0.2" />
    </svg>
  );
}
...
function CalendarIllustration() {
  return (
    <svg width="240" height="200" viewBox="0 0 240 200" fill="none">
      ...
      {/* Calendar header */}
      <rect x="40" y="30" width="160" height="40" rx="14" fill="#FFC72C" />
      <rect x="40" y="56" width="160" height="14" fill="#FFC72C" />
      {/* Calendar hooks */}
      ...
      <circle cx={58 + 2 * 20} cy={129} r="10" fill="#FFC72C" />
      ...
      {/* Decorative elements */}
      <circle cx="22" cy="60" r="10" fill="#FFC72C" opacity="0.08" />
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-colors duration-200 ${
                index === currentSlide ? 'bg-[#FFC72C]' : 'bg-[#E5E7EB]'
              }`}
